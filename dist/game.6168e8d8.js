...
var colorGame = {
    ...
    squareEvents: function squareEvents() {
        var game = this;
    ...
    generateRandomColors: function generateRandomColors() {
        var arr = [];
        for (var i = 0; i < this.squares.length; i++) {
    ...
    generateSquares: function generateSquares() {
    ...
    gameDifficulty: function gameDifficulty() {
    ...
    revertHeaderColors: function revertHeaderColors() {
        document.querySelector("h1").style.backgroundColor = "steelblue";
        this.message.innerHTML = "";
        this.reset.innerHTML = "New Colors";
        this.message.style.color = "steelblue";
...
//# sourceMappingURL=/game.6168e8d8.map